...
public class BotlistFragment extends Fragment  {
     ...
     * @return A new instance of fragment BotlistFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static BotlistFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_botlist, container, false);
    }
    ...
    {
        EditText et = (EditText) this.getActivity().findViewById(R.id.etSpend);
        double nummer = Double.parseDouble(et.getText().toString());

        Bot bot = MainActivity.farm.getNextBot(MainActivity.andi, nummer);
    ...
    public void refreshList()
    {
        ...
        for(int i = 0; i < MainActivity.BNet.getBots().size(); i++)
        {
            value.add(MainActivity.BNet.getBots().get(i).toString());
        }
        ArrayAdapter<String> items = new ArrayAdapter<String>(this.getActivity(), simple_list_item_1, text1, value);
        lv = (ListView) this.getActivity().findViewById(R.id.listView);
        lv.setAdapter(items);
